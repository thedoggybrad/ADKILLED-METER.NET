...
<html>
<head>
<link rel="dns-prefetch" href="//uploadnj.openspeedtest.com">
<link rel="dns-prefetch" href="//uploadjp.openspeedtest.com">
<link rel="dns-prefetch" href="//upload.openspeedtest.com">
<link rel="dns-prefetch" href="//uploadin.openspeedtest.com">
<link rel="dns-prefetch" href="//openspeedtest.scdn1.secure.raxcdn.com">
...
<meta property="og:image" content="https://open.cachefly.net/images/img.png"/>
<link rel="apple-touch-icon" sizes="180x180" href="https://open.cachefly.net/images/icons/apple-touch-icon.png">
<link rel="icon" type="image/png" sizes="32x32" href="https://open.cachefly.net/images/icons/favicon-32x32.png">
<link rel="icon" type="image/png" sizes="16x16" href="https://open.cachefly.net/images/icons/favicon-16x16.png">
<link rel="manifest" href="https://open.cachefly.net/images/icons/site.webmanifest">
<link rel="mask-icon" href="https://open.cachefly.net/images/icons/safari-pinned-tab.svg" color="#5bbad5">
<link rel="shortcut icon" href="https://openspeedtest.com/images/icons/favicon.ico">
<meta name="msapplication-TileColor" content="#ffc40d">
<meta name="msapplication-config" content="https://open.cachefly.net/images/icons/browserconfig.xml">
...
<body>
  ...
  var comopenspeedtesturl = {"serverList":[
     {"hostName":"//open.cachefly.net/downloading"},
     {"hostName":"//open.cachefly.net/downloading"}
 ]};
...
var comopenspeedtestuurl = {"serverList":[
     {"hostName":"//uploadeu.openspeedtest.com/upload"},
     {"hostName":"//uploadeu.openspeedtest.com/upload"}
 ...
 var comopenspeedtestcdn = "//open.cachefly.net";

 var TestServerip = 0;

 function ostOnload(){
  console.log("OpenSpeedtest.com V3 Loaded!")
 }
    ...
    var dlThreads = 4;
    var ulThreads = 2;
    var showResult = "//openspeedtest.com/results/widget.php?r=";
  </script>
...
<svg version="1.1" id="OpenSpeedtest" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="openSpeedtestApp">
 ...
 <symbol id="logo"  viewBox="0 0 262.79 50.38">
  ...
  <a target="_blank" href="http://openspeedtest.com?ref=WidgetV2-Intro&Auto=5">
...
<symbol id="mainGuagebg"  viewBox="0 0 295.93 270.18">
    <path fill="none" d="M64.32,256.41a137,137,0,1,1,192.09-24.8l-.07.09a134.45,134.45,0,0,1-24.71,24.71"/>
</symbol>

<symbol id="mainGuageBlue" viewBox="0 0 295.93 270.18">
    <path fill="none"  d="M64.32,256.41a137,137,0,1,1,192.09-24.8l-.07.09a134.45,134.45,0,0,1-24.71,24.71"/>
</symbol>

<symbol id="mainGuageWhite" viewBox="0 0 295.93 270.18">
    <path fill="none"  d="M64.32,256.41a137,137,0,1,1,192.09-24.8l-.07.09a134.45,134.45,0,0,1-24.71,24.71"/>  
</symbol>
...
<defs>
 ...
 <symbol id="resultCardMob" viewBox="0 0 88.1 65.79">
   ...
   <symbol id="downloadRc1" viewBox="0 0 66.93 13.85">
      <g>
        <text transform="translate(0 10.52)" class="rtext">DOWN<tspan x="36.08" y="0">L</tspan><tspan x="42.34" y="0">O</tspan><tspan x="50.71" y="0">AD</tspan></text>
      </g>  
 ...
 <symbol id="uploadRc2" viewBox="0 0 46.73 13.85">
      <g>
        <text transform="translate(0 10.52)" class="rtext">UP<tspan x="15.88" y="0">L</tspan><tspan x="22.14" y="0">O</tspan><tspan x="30.51" y="0">AD</tspan></text>
      </g>  
 ...
 <symbol id="jitterRc3" viewBox="0 0 39.95 13.85">
    <text class="rtext" transform="translate(0 9.64)">JI<tspan class="rtext" x="9.44" y="0">T</tspan><tspan x="16.36" y="0">TER</tspan></text>
...
<symbol id="upResultC2" viewBox="0 0 53.35 39.8">
 ...
 <symbol style="fill: url(#gradient)"  id="graphc1" viewBox="0 0 200 100">
  ...
  <symbol id="jitterMob" viewBox="0 0 58.1 35.77">
    ...
    <text x="-5" y="33.46"  class="rtextmbms">Jitter</text> 
    <text id="JitterResultMon" x="17" y="33.46"  class="jitter-Mob">--</text>
    <text id="JitterResultms" x="33" y="33.46"  class="rtextmbms">ms</text>

 </symbol>
 <symbol  id="settings" viewBox="0 0 100 125">
    <rect fill="transparent" x="0"  y="25" width="100" height="50"/>
    <path d="M36.43,29.64,9.29,50,36.43,70.36v6.78L2.5,56.79V43.21L36.43,22.86Z"/><path d="M63.57,70.36,90.71,50,63.57,29.64V22.86L97.5,43.21V56.79L63.57,77.14Z"/><circle cx="29.64" cy="50" r="6.79"/><circle cx="50" cy="50" r="6.79"/><circle cx="70.36" cy="50" r="6.79"/>
</symbol>
...
<symbol id="ConnectError" viewBox="0 0 489.6 489.6">
  ...
  <symbol class="Your-IP" viewBox="0 0 300 299.12">
    ...
    <text id="YourIP" transform="translate(140 230) scale(.8 1)">110.54.157.146</text>
...
<use id="mainGuagebg-Desk" class="main-Guagebg" xlink:href="#mainGuagebg" x="10.28" y="36.11" width="273.94" height="245.39"></use>
<use id="mainGuageBlue-Desk" class="main-GuageBlue" xlink:href="#mainGuageBlue" x="10.28" y="36.11" width="273.94" height="245.39"></use>
<use id="mainGuageWhite-Desk" class="main-GuageWhite" xlink:href="#mainGuageWhite" x="10.28" y="36.11" width="273.94" height="245.39"></use>
...
<g id="intro-Desk">
       ...
       <use id="deskStart" class="deskStart" xlink:href="#mainGuagebg" x="10.28" y="36.11" width="273.94" height="245.39"></use>
       ...
       <use id="mainGuagebg-Mob" class="main-Guagebg" xlink:href="#mainGuagebg" x="11.18" y="12" width="273.94" height="245.39"></use>
       <use id="mainGuageBlue-Mob" class="main-GuageBlue" xlink:href="#mainGuageBlue" x="11.18" y="12" width="273.94" height="245.39"></use>
       <use id="mainGuageWhite-Mob" class="main-GuageWhite" xlink:href="#mainGuageWhite" x="11.18" y="12" width="273.94" height="245.39"></use>
       ...
       <use id="progressStatus-Mob" class="intro-Progress" xlink:href="#introProgress" x="29" y="272" width="234.5" height="21.5">
           </use>  
...
<g id="intro-Mob">
       ...
       <use id="deskStartMob" class="deskStart" xlink:href="#mainGuagebg" x="11.18" y="12" width="273.94" height="245.39">
...
<script src="//open.cachefly.net/js/ostapp.js"></script>
